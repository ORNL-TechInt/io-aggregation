...
% Displays a box with text for the authors to make comments while they're
% writing the document.
% Comment this code out for the final submission!
% Sombody who's better with latex than me could probably make the command
% accept the author's name instead of hard-coding it. Others can just
% copy, paste and change the frametitle value.  -Ross
%\newmdenv[
%  backgroundcolor=yellow!100,
%  outerlinecolor=blue!70!black,
%  outerlinewidth=2,
%  roundcorner=10pt,
%  frametitle=Edit note (Ross),
%  skipabove=\topsep,
%  skipbelow=\topsep,
%]{Ross}
